export default {
  dgh: {
    singleProjectHeader: {
      singleProjectTitle: 'David Geffen Hall',
      singleProjectDate: '2022',
      singleProjectTag: 'Installation + Web Application',
    },
    projectImages: [
      {
        id: 1,
      ...
      companyInfos: [
        {
          id: 1,
          title: 'Name',
          details: 'Lincoln Center',
        },
        {
          id: 2,
          title: 'Services',
          details: 'Performing Arts',
        },
        {
          id: 3,
          title: 'Website',
          details: 'https://www.lincolncenter.org/',
        },
        {
          id: 4,
          title: 'Phone',
          details: '(212) 875-5456',
        },
      ],
      objectivesHeading: 'Objective',
      objectivesDetails:
        `This project is a digital signage solution for Geffen Hall, part of Lincoln Center in NYC.
        Custom displays and a content management software was built for this project.
        Content for the screens will be partially loaded from Lincoln Center’s existing CMS via a REST API.`,
      technologies: [
        {
  ...
  sfs: {
    singleProjectHeader: {
      singleProjectTitle: 'San Francisco Symphony',
  ...
  camden: {
    singleProjectHeader: {
      singleProjectTitle: 'Camden Battlefield',
      singleProjectDate: '2021',
      singleProjectTag: 'Installation + Mobile Application',
    },
    projectImages: [
      {
        id: 1,
